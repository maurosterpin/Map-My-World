...
if("TRUE" STREQUAL "TRUE")
  set(ball_chaser_SOURCE_PREFIX /home/workspace2/Map-My-World/src/ball_chaser)
  set(ball_chaser_DEVEL_PREFIX /home/workspace2/Map-My-World/devel)
  ...
  set(ball_chaser_INSTALL_PREFIX /home/workspace2/Map-My-World/install)
...
if(NOT "/home/workspace2/Map-My-World/devel/include " STREQUAL " ")
  set(ball_chaser_INCLUDE_DIRS "")
  set(_include_dirs "/home/workspace2/Map-My-World/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/workspace2/Map-My-World/src/ball_chaser/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/workspace2/Map-My-World/devel/lib;/opt/ros/kinetic/lib)
